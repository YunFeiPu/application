...
<!-- 页面基本设置禁止随意更改 -->
<!-- 基础CSS类库可随意更改 -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>css/less.css">
...
<div class="wrapper" style="background-color: white;">
  ...
  <div style="height: 60px;background-color: white;">
	<div style=";margin-left: 160px;">
		<img src="<?php echo base_url()?>images/log_1.jpg" />	
	</div>
  ...
  <form id="form1" action="/welcome/check" method="post">
        ...
        <div class="login-topStyle" >
          ...
          <div class="login-topStyle3" id="loginStyle" style="margin-top: 75px;">
            ...
            <div class="ui-form-item loginUsername">
              <input type="username" name="account" maxlength="20" placeholder="用户名/手机号/密码">
            </div>
            ...
            <span class="error_xinxi" style="display:none;">您输入的密码不正确，请重新输入</span> <a class="btnStyle btn-register" id="submit" href="#"> 立即登录</a> </div>
        </div>
      </div>
    </div>
 </form>
      ...
      <div class="loginCenter-moudle">
        ...
        <div class="loginCenter-moudleRight" style="  width: 1067px;"> 
          ...
          <a class="loginCenter-mStyle loginCenter-moudle1" id="moudleRemove" style=" display:block;width: 340px;">
           <span class="moudle-img"><img src="<?php echo base_url()?>images/login_bg_01.png"></span>
          ...
          <span class="moudle-img"><img src="<?php echo base_url()?>images/login_bg_02.png"></span> 
           <span class="moudle-text">
            ...
            <!--第三个--> 
                 ...
                 <span class="moudle-img"><img src="<?php echo base_url()?>images/login_bg_03.png"></span> 
                   <span class="moudle-text"> 
  ...
  <div class="footer"> <span class="footerText">Copyright © 2013-2017   </span> </div>
</div>
</body>
</html>