...
<body>
    ...
    <table width="100%" class="TR_MOUSEOVER   TOGGLE">
        ...
        <thead>
            <tr>
                <th>ID号</th><th>商家名称</th><th>客户组</th><th>联系人</th><th>联系电话</th><th>地址</th><th>备注</th><th>操作</th>
            </tr>
        </thead>
        <tfoot>
            <tr>
                <th colspan="6"><?php echo $pages; ?></th><th>
        ...
        <tbody>
            ...
            <?php foreach ($item_list as $item)://custom_list?>
                <tr>
                    ...
                    <td><a href="<?php echo base_url() ?>custom/modi/<?php echo $item->id; ?>">修改</a> | <a href="<?php echo base_url() ?>custom/dele/<?php echo $item->id; ?>" onclick="return confirm('您确定要删除当前选项吗?该操作不可恢复！')">删除</a></td>
                </tr>
        <?php endforeach;?>
        </tbody>
    </table>
