...
$(window).unbind('beforeunload');
    ...
    $("#btnAddOrder").click(function(){
        ...
        if(_cindex === 0){        
            ...
            $("#lbltotal").html(parseFloat($("#lbltotal").html())+ parseFloat(total));
            $("#txtpname").val("");
            $("#txtpset").val("");
            $("#txtprice").val("");
            $("#txtqty").val("");
...
<div id="dialog-submit" style="display:none;" title="提交订单">
     ...
     <div id="dialog-addproduct" title="添加产品">
         <table>
             ...
             <tr >
                 <td colspan="2"><input type="button" id="btnAddOrder" value="添加到订单" tabindex="3"></input></td>
             </tr>
         </table>
