		...
		$((function($){
			...
			$(function(){
				...
				$( "#mysubmit" ).click(function(){
					window.location.href = "./code/assssdadfdfsda/"+$( "#v_sdate" ).val();
				});
				...
				<body>
				<h3>查看订货单据</h3>
				<?php echo form_open('code/assssdadfdfsda'); ?>
   请选择配送日期<?php
            $data = array(
              'name'        => 'v_sdate',
              'id'          => 'v_sdate',
    ...
    <table width="100%" class="TR_MOUSEOVER   TOGGLE">
        ...
        <tbody>
           ...
           <?php foreach ($ghd_list as $item)://custom_list?>
                <tr>
                    <td><a href="/gonghuodan/getghdlistbygys/<?php echo $item->gys_id?>"><?php echo $item->gys_name;?></a></td>
                    <td><?php echo $item->ghd_jine;?></td>
                    <td><?php echo $item->ghd_date;?></td>
                    
                    <td><?php echo number_format($item->ghd_jiesuan_jine,2);?></td>
